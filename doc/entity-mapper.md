...
- γ: *Book.store* is a many-to-one reference.
    ...
    - Base on midde table
        ...
        a. Many-to-one association is base on foreign key, not base on middle table
        b. The column name of the foreign key matches the kotlin property name. for example: kotlin property name is "word1Word2" and foreign key column name is "WORD1_WORD2_ID".
        c. No delete action.
